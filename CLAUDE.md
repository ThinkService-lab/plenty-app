...
- Usage limits: 2 free/day (Firestore), anonymous gate (localStorage, 2 tries)
...
2. **Save favourite meals** — Firestore under user uid
3. **Shopping list generator** — from a selected meal's ingredients
